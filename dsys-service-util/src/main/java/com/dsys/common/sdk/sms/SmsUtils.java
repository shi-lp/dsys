...
public class SmsUtils {
    ...
    /**
     * @discription 产品名称:云通信短信API产品,开发者无需替换
     * @author shilp
     * @created 2020/6/16  19:37
     * @Param
     * @Return
    */
    ...
    */
    ...
    /**
     * @discription 必填:短信签名-可在短信控制台中找到
     * @author shilp
     * @created 2020/6/16  19:37
     * @Param
     * @Return
    */
    ...
    /**
     * @discription 必填:短信模板-可在短信控制台中找到
     * @author shilp
     * @created 2020/6/16  19:38
     * @Param
     * @Return
    */
...
//		request.setSmsUpExtendCode("90997");
        ...
        /**
         * s可选:outId为提供给业务方扩展字段,最终在短信回执消息中将此值带回给调用者
        */
        ...
        if (response.getCode() != null && "OK".equals(response.getCode()) && detail) {
