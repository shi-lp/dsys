 ...
 * @created 2020/5/26 17:19
 */
public class JedisUtil{
    
    public JedisUtil(){
        this.jedisPool = (JedisPool)ContextUtil.getBean("jedisPool");
    }
    ...
    private void closeJedis (Jedis jedis){
        try {
            ...
            throw new CustomException(GlobalExceptionType.SYSTEM_ERROR,e.getMessage());
        }
    }
...
//
//        String werwe = JedisUtil.getInstance().strings().set("werwe", JSON.toJSONString(map));
//        System.out.println(werwe);
//        String s = JedisUtil.getInstance().strings().get("werwe");
