...
import com.dsys.goods.util.GoodsUtils;
...
public class GoodsCategoryController{
    ...
    */
    ...
    public RenderResponse getCategory(@PathVariable(value = "levelNo") String levelNo,
        ...
        return RenderResponse.success(GoodsUtils.cateToOption(cateList));
    }
    
    /**
     * @discription 新增获取分类编码
     * @author shilp
     * @created 2020/7/20  17:13
     * @Param
     * @Return
    */
    @GetMapping(value = "/categories/code/{levelNo}")
    public RenderResponse getCateCode(@PathVariable(value = "levelNo") String levelNo,
                                      @RequestParam(value = "parentCode") String parentCode){
        String code = goodsCategoryService.getCodeByLevel(levelNo,parentCode);
        return RenderResponse.success(code);
    }
}
