...
public class PasswordUtil{
    ...
    /**
     * 定义使用的算法为:PBEWITHMD5andDES算法,加密算法,PKCS5Padding/DES/CBC
     */
     ...
     * @Return
    */
    public static final String SALT = "297514094";
     ...
     * @return Key PBE算法密钥
     * */
    private static SecretKey getPBEKey(String password) {
        // 实例化使用的算法
